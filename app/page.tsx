export default function Home() {
  const ctaDsfUrl = "https://wa.me/27604791417?text=Halo%20DSF%2C%20saya%20mau%20buat%20web%20seperti%20ini";

  return (
    <>
      <header className="header">
        <div className="container header-content">
          <div className="logo">DSF Furniture</div>
      ...
      <main>
          ...
          <div className="container hero-content">
            <div className="hero-text">
              ...
              <p className="hero-subtitle">
                DSF Furniture menghadirkan pilihan furniture untuk rumah, kantor, cafe, dan ruang usaha dengan desain modern, rapi, dan fungsional.
              </p>
        ...
        <section id="about" className="section section-bg-white">
          <div className="container">
            <h2 className="section-title">Tentang DSF Furniture</h2>
            <div className="about-content">
              <p className="about-text">
                DSF Furniture adalah toko furniture yang menyediakan berbagai pilihan produk untuk kebutuhan rumah dan ruang usaha. Kami membantu pelanggan menemukan furniture yang sesuai dengan gaya ruangan, kebutuhan fungsi, dan kenyamanan penggunaan.
              </p>
        ...
        <section id="products" className="section section-bg-cream">
          <div className="container">
            ...
            <div className="products-grid">
              ...
              <div className="product-card">
                <div className="product-img-wrapper">
                  <img src="/img/3.jpeg" alt="Meja dan Kursi" className="product-img" />
                </div>
                <div className="product-info">
              ...
              <div className="product-card">
                <div className="product-img-wrapper">
                  <img src="/img/4.jpeg" alt="Lemari" className="product-img" />
                </div>
                <div className="product-info">
              ...
              <div className="product-card">
                <div className="product-img-wrapper">
                  <img src="/img/5.jpeg" alt="Rak TV" className="product-img" />
                </div>
                <div className="product-info">
              ...
              <div className="product-card">
                <div className="product-img-wrapper">
                  <img src="/img/6.jpeg" alt="Tempat Tidur" className="product-img" />
                </div>
                <div className="product-info">
              ...
              <div className="product-card">
                <div className="product-img-wrapper">
                  <img src="/img/7.jpeg" alt="Furniture Custom" className="product-img" />
                </div>
                <div className="product-info">
        ...
        <section id="advantages" className="section section-bg-white">
          <div className="container">
            <h2 className="section-title">Kenapa Memilih DSF Furniture?</h2>
        ...
        <section id="contact" className="section section-bg-cream">
          <div className="container">
            <div className="contact-wrapper">
              <h2 className="section-title" style={{ paddingBottom: '15px' }}>Kunjungi dan Hubungi DSF Furniture</h2>
              <div className="contact-info">
                <p>📍 <strong>Area layanan:</strong> Bekasi dan sekitarnya</p>
                <p>📞 <strong>WhatsApp:</strong> +27 604 791 417</p>
              </div>
              <a href="https://wa.me/27604791417" className="btn btn-primary">Hubungi Toko</a>
            </div>
            
            {/* 8. CTA Halus untuk Jasa Website */}
            <div className="cta-service">
              <h2>Ingin Website Toko Seperti Ini?</h2>
              <p>Website demo ini dibuat oleh DSF untuk menunjukkan bagaimana toko furniture bisa tampil lebih rapi, profesional, dan mudah dihubungi secara online.</p>
              <a href={ctaDsfUrl} target="_blank" rel="noopener noreferrer" className="btn btn-accent">Saya Mau Buat Web Seperti Ini</a>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-logo">DSF Furniture</div>
          <p className="footer-desc">Furniture untuk rumah, kantor, cafe, dan ruang usaha.</p>
          <div className="footer-credits">
            <p>Demo website by DSF</p>
            <p>WhatsApp: <a href={ctaDsfUrl} target="_blank" rel="noopener noreferrer">+27 604 791 417</a></p>
          </div>
        </div>
      </footer>

      {/* Sticky WhatsApp for Web Design Service */}
      <a href={ctaDsfUrl} target="_blank" rel="noopener noreferrer" className="sticky-wa">
